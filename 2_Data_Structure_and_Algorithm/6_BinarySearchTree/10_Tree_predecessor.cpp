...
TreeNode* maxFinder(TreeNode *&root){
...
TreeNode* treePredecessor(TreeNode *root,int base){
    ...
    while (parentFinder!=NULL && temp == parentFinder->left){
        temp = parentFinder;
...
int main() {
    ...
    cout<<treePredecessor(root,10)->val;
